...
void LPHashTable<K, V>::insert(K const &key, V const &value)
{
     ...
     */
    if (static_cast<double>(elems + 1) / size >= 0.7)
    {
        resizeTable();
    }
...
void LPHashTable<K, V>::resizeTable()
{
    ...
    std::pair<K, V> **temptable = new std::pair<K, V> *[newSize];
    bool *tempbool = new bool[newSize];
